...
\context StaffGroup = "all" <<
 ...
 \override Staff.StaffSymbol.line-positions = #'(0)
    \set DrumStaff.drumStyleTable = #(alist->hash-table mydrums)
		\drummode {
      \time 41/16
  sn16-> r16 r16 r16 r16 r16 r16 r16 sn16-> sn16-> r16 sn16 r16 r16 sn16-> r16 r16 sn16 r16 sn16-> sn16 sn16 sn16 r16 r16 sn16-> sn16 sn16-> sn16 r16 r16 sn16-> r16 sn16 r16 sn16 sn16-> r16 r16 sn16 sn16
		}
	}
